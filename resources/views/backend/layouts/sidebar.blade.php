...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <img class="app-sidebar__user-avatar" src="{{ auth()->user()->profile_image ? asset(auth()->user()->profile_image) : 'default-image-path' }}" alt="User Image">
        <div>
    ...
    <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{ route('ratemanagement') }}"><i class="icon bi bi-circle-fill"></i>Add New</a></li>
                <li><a class="treeview-item" href="{{ route('ratemanagement') }}"><i class="icon bi bi-circle-fill"></i>All Customers</a></li>
            </ul>
        </li>
        {{-- User --}}
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="{{ route('usermanagement') }}"><i class="icon bi bi-circle-fill"></i>User List</a></li>
            </ul>
        </li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="{{ route('vehiclemanagement') }}"><i class="icon bi bi-circle-fill"></i>Vehicle List</a></li> 
            </ul>
        </li>
